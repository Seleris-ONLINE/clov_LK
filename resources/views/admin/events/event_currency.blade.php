...
@section('admin-content')
    ...
    @if ($currency->id)
        ...
        @if (Settings::get('event_global_score'))
            ...
            <p>
                ...
                @if (Auth::user()->hasPower('edit_pages'))
                    You can edit this page <a href="{{ url('/admin/pages/edit/' . $page->id) }}">here</a>.
                @endif
            </p>
    ...
    <p>
        Here you can set teams that users may join as part of an event. Note that teams <strong>must be enabled</strong> for this to have any effect, but you may still adjust these settings, e.g. to perform setup, with the setting disabled. Teams can
        optionally have a logo image.<br />
